...
!(function(a, b) {
  ...
  ;(r.fn = r.prototype = {
    ...
    var a,
      ...
      j = !1
    for (
      'boolean' == typeof g && ((j = g), (g = arguments[h] || {}), h++), 'object' == typeof g ||
        r.isFunction(g) ||
        (g = {}), h === i && ((g = this), h--);
      h < i;
      h++
  ...
  var x = (function(a) {
    ...
    ;(c = ga.support = {}), (f = ga.isXML = function(a) {
      ...
      preFilter: {
        ATTR: function(a) {
          return (a[1] = a[1].replace(_, aa)), (a[3] = (a[3] || a[4] || a[5] || '').replace(_, aa)), '~=' === a[2] &&
            (a[3] = ' ' + a[3] + ' '), a.slice(0, 4)
        },
        CHILD: function(a) {
    ...
    return (h = ga.compile = function(a, b) {
      ...
      u.split('').sort(B).join('') === u), (c.detectDuplicates = !!l), m(), (c.sortDetached = ja(function(a) {
    ...
    queue: function(a, b, c) {
      ...
      if (a)
        return (b = (b || 'fx') + 'queue'), (d = W.get(a, b)), c &&
          (!d || Array.isArray(c) ? (d = W.access(a, b, r.makeArray(c))) : d.push(c)), d || []
    },
    ...
    for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o; n++)
      if (((f = a[n]), f || 0 === f))
        if ('object' === r.type(f)) r.merge(m, f.nodeType ? [f] : f)
          ...
          ;(g = g || l.appendChild(b.createElement('div'))), (h = (ka.exec(f) || ['', ''])[1].toLowerCase()), (i =
            ma[h] || ma._default), (g.innerHTML = i[1] + r.htmlPrefilter(f) + i[2]), (k = i[0])
          ...
          if (1 === j.nodeType && ('click' !== a.type || j.disabled !== !0)) {
            for (f = [], g = {}, c = 0; c < i; c++)
              (d = b[c]), (e = d.selector + ' '), void 0 === g[e] &&
                (g[e] = d.needsContext ? r(e, this).index(j) > -1 : r.find(e, this, null, [j]).length), g[e] &&
                f.push(d)
  ...
  r.extend({
    ...
    css: function(a, b, c, d) {
      ...
      return i || (b = Xa(h)), (g = r.cssHooks[b] || r.cssHooks[h]), g &&
        'get' in g &&
        (e = g.get(a, !0, c)), void 0 === e && (e = Oa(a, b, d)), 'normal' === e && b in Ta && (e = Ta[b]), '' === c ||
      c
  ...
  ;(r.Tween = _a), (_a.prototype = {
    ...
    init: function(a, b, c, d, e, f) {
      ;(this.elem = a), (this.prop = c), (this.easing =
        e || r.easing._default), (this.options = b), (this.start = this.now = this.cur()), (this.end = d), (this.unit =
        f || (r.cssNumber[c] ? '' : 'px'))
    },
    cur: function() {
    ...
    return r.fx.off
      ...
      : 'number' != typeof d.duration &&
        (d.duration in r.fx.speeds
          ...
          : (d.duration = r.fx.speeds._default)), (null != d.queue && d.queue !== !0) || (d.queue = 'fx'), (d.old =
    ...
    trigger: function(b, c, e, f) {
      ...
      if (
        ...
        while ((h = o[g++]) && !b.isPropagationStopped())
          (b.type = g > 1 ? j : n.bindType || p), (m = (W.get(h, 'events') || {})[b.type] && W.get(h, 'handle')), m &&
  ...
  r.extend({
    ...
    ajax: function(b, c) {
      ...
      ;(l = r.event && o.global), l &&
        0 === r.active++ &&
        r.event.trigger('ajaxStart'), (o.type = o.type.toUpperCase()), (o.hasContent = !Gb.test(
        o.type
  ...
  r.ajaxSetup({
    ...
    if (h || 'jsonp' === b.dataTypes[0])
      return (e = b.jsonpCallback = r.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback), h
        ? (b[h] = b[h].replace(Ub, '$1' + e))
        : b.jsonp !== !1 && (b.url += (vb.test(b.url) ? '&' : '?') + b.jsonp + '=' + e), (b.converters[
        'script json'
      ] = function() {
    ...
    setOffset: function(a, b, c) {
      ...
      'static' === k && (a.style.position = 'relative'), (h = l.offset()), (f = r.css(a, 'top')), (i = r.css(
        a,
        'left'
      )), (j = ('absolute' === k || 'fixed' === k) && (f + i).indexOf('auto') > -1), j
